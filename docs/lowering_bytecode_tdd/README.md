...
| [04](phase_04_artifact_and_soa.md) | Additive versioned aligned SoA artifact and owner | Synthetic-model emit/bind validation works; current numerical execution remains unchanged. |
