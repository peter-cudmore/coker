...
use crate::{
    ...
    workspace::{copy_evaluate_outputs, pack_evaluate_inputs, pack_evaluate_tangents, Workspace},
};
...
fn execute_evaluate_layer(
    ...
    execute_program_layers(module, callee_program, &mut nested_workspace);
